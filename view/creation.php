            ...
            <form method="post" action="../controller/utilisateurController.php?action=create&connexionV=<?php echo $connexionV; ?>">
                <div class="step active">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tel" name="tel" placeholder="Entrez votre numero de telephone">
                    </div>
                ...
                <div class="step">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ville" name="ville" placeholder="Entrez votre cin">
                    </div>
                    <div class="form-group">
